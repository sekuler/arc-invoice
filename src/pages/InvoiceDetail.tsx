...
export default function InvoiceDetail({ invoice, onClose }: Props) {
  ...
  style={{ padding: "6px 16px", borderRadius: 20, border: "none", background: "linear-gradient(135deg, #7c3aed, #6366f1)", color: "#fff", fontSize: 12, fontWeight: 700, textDecoration: "none", boxShadow: "0 0 14px rgba(99,102,241,0.5)", display: "flex", alignItems: "center", gap: 6 }}>
  &#x2192; Send
</a>
          )}
        </div>
